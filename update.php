...
$content = array('chat_id' => $chat_id, 'reply_markup' => $keyb, 'text' => "Parametri Ricerca:"."/n/rMarca:".$_SESSION["marca"]."/nModello:".$_SESSION["modello"]."/rRegione:".$_SESSION["regione"]."Provincia:".$_SESSION["provincia"]."Alimentazione:".$_SESSION["alimentazione"]."Prezzo:".$_SESSION["prezzo"].$_SESSION['total_elements'][$_SESSION["$i"]]);
}
