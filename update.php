...
$option = array( 
    //First row
    array($telegram->buildInlineKeyBoardButton("Esegui Ricerca", $url="http://google.it"), $telegram->buildInlineKeyBoardButton("Skip",  url='htt$p://link321.it', 'callback_data' => 'myCallbackText')));
