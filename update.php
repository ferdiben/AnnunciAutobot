...
$callback_datas = $callback_query->getData();
...
$content = array('chat_id' => $chat_id, 'reply_markup' => $keyb, 'text' => $questions[0].$callback_query_id.$callback_query['inline_message_id']);
}
